...
set VSVER=150
set "VSVARS32FILE=D:\buildtools\VisualStudio2019\VC\Auxiliary\Build\vcvars32.bat"
if not "%VS150COMNTOOLS%"=="" (
    set "VS150COMNTOOLS=%VS150COMNTOOLS%"
) else (
  if exist "%VSVARS32FILE%" set "VS150COMNTOOLS=D:\buildtools\VisualStudio2019\VC\Auxiliary\Build"
)
